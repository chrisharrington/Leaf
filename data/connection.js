...
exports.open = function() {
	return new Promise(function(resolve, reject) {
		mongoose.connect("mongodb://" + config.call(this, "databaseUser") + ":" + config.call(this, "databasePassword") + "@ds048537.mongolab.com:48537/leaf-experimental", { server: { socketOptions: { keepAlive: 1 } } });
